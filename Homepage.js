    ...
    <div className="contact-us" id="contact">
      ...
      <div style={{ width: "60vw" }}>
        <iframe
          ...
          marginHeight="0"
          marginWidth="0"
          src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=SR%20Nagar%20,%20Babu%20Nagar+(myportfolio)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
          title="Google Maps"
        >
    ...
    <footer className="footer-bar">
      <div className="footer-content">
        ...
        <div className="footer-social">
          ...
          <a
            href="https://i.postimg.cc/3xZHb9vG/Full-Stack-Resume-Akhil.png"
            aria-label="Resume"
            target="_blank"
            rel="noopener noreferrer"
          >
